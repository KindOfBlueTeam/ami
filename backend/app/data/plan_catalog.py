...
PLAN_CATALOG: list[dict] = [
    ...
    # ── Gemini ─────────────────────────────────────────────────────────────────
    {
        ...
        "plans": [
            ...
            dict(name="Advanced", slug="advanced", billing_interval="annual",
                 default_price_usd=199.99, monthly_equivalent_usd=16.67, is_free=False,
                 notes="$199.99/year ($16.67/mo equivalent). Google One AI Premium annual plan."),
        ],
    },
    ...
    # ── GitHub Copilot ─────────────────────────────────────────────────────────
    {
        ...
        "plans": [
            ...
            dict(name="Business",   slug="business",   billing_interval="monthly",
                 ...
                 notes="Per seat, org management features. No annual option."),
        ],
    },
    ...
    # ── ElevenLabs ─────────────────────────────────────────────────────────────
    {
        ...
        "plans": [
            ...
            dict(name="Starter", slug="starter", billing_interval="annual",
                 default_price_usd=50.0, monthly_equivalent_usd=4.17, is_free=False,
                 notes="$50/year ($4.17/mo equivalent). 2 months free vs monthly."),
            ...
            dict(name="Pro",     slug="pro",     billing_interval="annual",
                 default_price_usd=990.0, monthly_equivalent_usd=82.50, is_free=False,
                 notes="$990/year ($82.50/mo equivalent). 2 months free vs monthly."),
        ],
    },
