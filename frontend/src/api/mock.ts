...
const PROVIDERS: Provider[] = [
  { id: 1,  name: 'ChatGPT',       website: 'https://chat.openai.com',             category: 'chat',   logo_color: '#10A37F', is_consumer: true, account_url: 'https://chat.openai.com/',                             billing_url: 'https://platform.openai.com/account/billing/overview', link_notes: 'Billing may be managed via Apple or Google subscriptions if purchased via mobile' },
  { id: 2,  name: 'Claude',        website: 'https://claude.ai',                   category: 'chat',   logo_color: '#D97706', is_consumer: true, account_url: 'https://claude.ai/',                                   billing_url: 'https://claude.ai/settings/billing',                   link_notes: 'Login may be via Google; billing managed in-app' },
  { id: 3,  name: 'Gemini',        website: 'https://gemini.google.com',           category: 'chat',   logo_color: '#4285F4', is_consumer: true, account_url: null,                                                   billing_url: null,                                                    link_notes: null },
  { id: 4,  name: 'Perplexity',    website: 'https://perplexity.ai',               category: 'chat',   logo_color: '#20808D', is_consumer: true, account_url: 'https://www.perplexity.ai/settings',                   billing_url: 'https://www.perplexity.ai/settings/billing',           link_notes: 'Pro subscription managed via web or mobile store' },
  { id: 5,  name: 'MidJourney',    website: 'https://midjourney.com',              category: 'image',  logo_color: '#7C3AED', is_consumer: true, account_url: 'https://www.midjourney.com/account/',                  billing_url: 'https://www.midjourney.com/account/',                  link_notes: 'Also accessible via Discord /subscribe' },
  { id: 6,  name: 'Adobe Firefly', website: 'https://firefly.adobe.com',           category: 'image',  logo_color: '#FF0000', is_consumer: true, account_url: null,                                                   billing_url: null,                                                    link_notes: null },
  { id: 7,  name: 'Suno',          website: 'https://suno.com',                    category: 'audio',  logo_color: '#EC4899', is_consumer: true, account_url: 'https://suno.com/account',                             billing_url: 'https://suno.com/account',                             link_notes: 'Credits and subscription managed in account page' },
  { id: 8,  name: 'Udio',          website: 'https://udio.com',                    category: 'audio',  logo_color: '#8B5CF6', is_consumer: true, account_url: null,                                                   billing_url: null,                                                    link_notes: null },
  { id: 9,  name: 'GitHub Copilot',website: 'https://github.com/features/copilot', category: 'coding', logo_color: '#24292E', is_consumer: true, account_url: 'https://github.com/settings/copilot',                 billing_url: 'https://github.com/settings/billing',                  link_notes: 'Managed through GitHub billing settings' },
  { id: 10, name: 'Cursor',        website: 'https://cursor.sh',                   category: 'coding', logo_color: '#1A1A1A', is_consumer: true, account_url: 'https://cursor.sh/settings',                           billing_url: 'https://cursor.sh/settings/billing',                   link_notes: 'Billing tied to Cursor account' },
  { id: 11, name: 'Runway',        website: 'https://runwayml.com',                category: 'video',  logo_color: '#000000', is_consumer: true, account_url: 'https://app.runwayml.com/account',                     billing_url: 'https://app.runwayml.com/account',                     link_notes: 'Credits and subscription managed in dashboard' },
  { id: 12, name: 'Pika',          website: 'https://pika.art',                    category: 'video',  logo_color: '#6366F1', is_consumer: true, account_url: 'https://pika.art/account',                             billing_url: 'https://pika.art/account',                             link_notes: 'Video generation credits and subscription' },
  { id: 13, name: 'Luma AI',       website: 'https://lumalabs.ai',                 category: 'video',  logo_color: '#0EA5E9', is_consumer: true, account_url: 'https://lumalabs.ai/account',                          billing_url: 'https://lumalabs.ai/account',                          link_notes: 'Billing tied to account dashboard' },
  { id: 14, name: 'ElevenLabs',    website: 'https://elevenlabs.io',               category: 'audio',  logo_color: '#F97316', is_consumer: true, account_url: 'https://elevenlabs.io/subscription',                   billing_url: 'https://elevenlabs.io/subscription',                   link_notes: 'Usage and billing managed in subscription page' },
  { id: 15, name: 'Stability AI',  website: 'https://dreamstudio.ai',              category: 'image',  logo_color: '#6D28D9', is_consumer: true, account_url: 'https://dreamstudio.ai/account',                       billing_url: 'https://dreamstudio.ai/account',                       link_notes: 'Pay-as-you-go credits system' },
  { id: 16, name: 'Leonardo AI',   website: 'https://app.leonardo.ai',             category: 'image',  logo_color: '#92400E', is_consumer: true, account_url: 'https://app.leonardo.ai/account',                      billing_url: 'https://app.leonardo.ai/account',                      link_notes: 'Credits and subscription managed in app' },
  { id: 17, name: 'Replit',        website: 'https://replit.com',                  category: 'coding', logo_color: '#F55F27', is_consumer: true, account_url: 'https://replit.com/account',                           billing_url: 'https://replit.com/account/billing',                   link_notes: 'Part of Replit subscription (includes Ghostwriter)' },
]
